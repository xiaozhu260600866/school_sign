<template>
  <div>
    <dx-create-edit ref="createEdit" create-action="/admin/video/create" edit-action="/admin/video/edit" :fields="globalData.data.formFields" :data="data" no-dialog="true" create-edit-label="120px">
